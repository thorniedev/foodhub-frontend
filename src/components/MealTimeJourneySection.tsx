  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* grain - hidden on mobile to avoid heavy SVG filter rasterization */}
        <div
          className="hidden md:block pointer-events-none absolute inset-0 z-[16] h-full w-full opacity-[0.15] mix-blend-overlay"
          style={{
