    ...
    <ReactLenis root>
      <main className="w-full bg-white">
        {/* <div className="top-22 absolute left-1/2 z-10 grid -translate-x-1/2 content-start justify-items-center gap-6 text-center text-black">
          <span className="relative max-w-[12ch] text-base uppercase leading-tight opacity-40 after:absolute after:left-1/2 after:top-full after:h-16 after:w-px after:bg-gradient-to-b after:from-[#f5f4f3] after:to-black after:content-['']">
            Scroll to see more
          </span>
        </div> */}
        <div
          ref={targetRef}
          className="relative box-border flex h-[10vh] items-center justify-center gap-[2vw] overflow-hidden "
        >
          <div
