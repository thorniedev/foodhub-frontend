...
function ProfileCard({
  ...
  return (
    ...
    >
      {/* =====================================================
          PROFILE IDENTITY
          Same structure/height for every card.
          Default profile gets strong contrast without
          adding extra vertical content.
      ===================================================== */}
      <Link
        href={`/dashboard/family-profile/${fullMember.uuid}`}
        className="block p-3 pb-0 focus-visible:outline-none"
      >
        <div
        ...
        >
          {/* Avatar wrapper.
              The active dot sits OUTSIDE overflow-hidden. */}
          ...
          <div className="min-w-0 flex-1">
            <div className="flex min-w-0 items-center gap-2">
              ...
              {/* {isDefault && (
                <span className="hidden h-8 w-8 shrink-0 items-center justify-center rounded-full bg-white/15 text-white sm:inline-flex">
      ...
      <div className="flex flex-1 flex-col p-5 pt-4 sm:p-6 sm:pt-5">
        ...
        >
          <span className="flex min-w-0 items-center gap-2">
            ...
            <span className="truncate">ណែនាំម្ហូបសម្រាប់គណនីនេះ</span>
          </span>
...
//         <div className="absolute right-2 top-2 z-10 inline-flex items-center gap-2 rounded-full border border-amber-200 bg-amber-50 px-3 py-1.5 text-lg font-semibold text-amber-700 shadow-sm">
//           {/* <Crown className="h-4 w-4" /> */}
//           លំនាំដើម
//         </div>
//       )}
