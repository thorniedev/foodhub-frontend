...
function FilterSection({
  ...
  return (
    <div className="border-t border-gray-100 dark:border-slate-800 py-4 first:border-t-0 first:pt-0">
      ...
      >
        <span className="flex items-center gap-2 text-[18px] font-semibold text-primary-900 dark:text-white">
...
function CheckboxOption({
  ...
  return (
    <label className="flex cursor-pointer items-center justify-between gap-3 rounded-xl px-2 py-2 transition hover:bg-primary-50 dark:hover:bg-slate-800/60">
      ...
      {typeof count === "number" && (
        <span className="shrink-0 rounded-full bg-gray-100 dark:bg-slate-800 px-2 py-0.5 text-[16px] text-gray-500 dark:text-slate-400">
          {count}
        </span>
      )}
    </label>
...
function OptionList({
  ...
  return (
    <div className="max-h-[240px] space-y-1 overflow-y-auto pr-1 [scrollbar-width:thin] [scrollbar-color:#d1d5db_transparent] dark:[scrollbar-color:#475569_transparent]">
      {options.map((option) => (
        <CheckboxOption
          key={option.code}
          label={option.name}
          ...
          <button
            ...
            className={`rounded-full border px-3 py-2 text-[18px] transition ${
              isSelected
                ...
                : "border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-gray-600 dark:text-slate-300 hover:border-primary-400 dark:hover:border-emerald-500 hover:bg-primary-50 dark:hover:bg-slate-700"
            }`}
          >
            {option.label}
          </button>
...
export default function StoreMenuFilterSidebar({
  ...
  const content = (
    <div className="flex h-full flex-col overflow-hidden rounded-[24px] border border-gray-100 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm">
      ...
      <div
        className={`shrink-0 border-b border-gray-100 dark:border-slate-800 ${
      ...
      >
        ...
        >
          ...
          {mobile ? (
            <button
              type="button"
              onClick={onClose}
              className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-50 dark:bg-slate-800 text-[24px] text-gray-500 dark:text-slate-300"
        ...
        {(!collapsed || mobile) && (
          <div className="mt-4 flex items-center justify-between rounded-xl bg-gray-50 dark:bg-slate-800/60 px-3 py-2.5">
            <p className="text-[18px] text-gray-500 dark:text-slate-400">
        ...
        <div className="flex flex-1 flex-col items-center gap-3 overflow-y-auto px-3 py-4">
          {[
            ...
            <motion.button
              ...
              className="flex h-11 w-11 items-center justify-center rounded-full text-[21px] text-primary-700 dark:text-emerald-400 hover:bg-primary-50 dark:hover:bg-slate-800 transition-colors"
            >
              {item.icon}
            </motion.button>
          ))}
        ...
        <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain px-5 pb-6 pt-2 [scrollbar-width:thin] [scrollbar-color:#d1d5db_transparent] dark:[scrollbar-color:#475569_transparent] [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-thumb]:bg-slate-700">
                ...
                return (
                  ...
                  >
                    <input
                      ...
                      className="h-4 w-4 accent-primary-800 dark:accent-emerald-500"
                    />
          ...
          {options.categories.length > 0 && (
            ...
            >
              ...
              {/* Keep Searchbox */}
              <div className="mb-3 flex min-h-11 items-center gap-2 rounded-xl border border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-slate-800/70 px-3">
                <IoSearchOutline className="shrink-0 text-[20px] text-gray-400 dark:text-slate-400" />
                ...
                <input
                  ...
                  className="w-full bg-transparent text-[18px] text-gray-600 dark:text-slate-200 outline-none placeholder:text-gray-400 dark:placeholder:text-slate-500"
                />
              </div>
          ...
          {(options.seasons.length > 0 ||
            ...
            >
              <div className="space-y-5">
                {options.seasons.length > 0 && (
                  <div>
                    <p className="mb-2 text-[18px] font-semibold text-gray-600 dark:text-slate-300">
                      រដូវកាល
                    </p>
