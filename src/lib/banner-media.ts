...
export function resolveBannerImageUrl(
  bannerOrUrl: { imageUrl?: string | null; image?: string | null; imageMediaUuid?: string | null } | string | null | undefined,
  ...
  const rawUrl =
    ...
    bannerOrUrl.image ||
    (bannerOrUrl.imageMediaUuid ? `/api/v1/media/${bannerOrUrl.imageMediaUuid}/file` : null);
