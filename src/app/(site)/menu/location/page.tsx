...
import RecommendationModeTabs from "@/components/food-page/location/RecommendationModeTabs";
...
export default function LocationPage() {
  ...
  return (
    <>
        ...
        <div className="mx-auto flex w-full max-w-7xl px-4 py-3 sm:px-6 flex-col lg:flex-row lg:items-center gap-4">
          <div className="flex flex-col sm:flex-row sm:items-center gap-4 shrink-0">
            ...
            <div className="w-full sm:w-auto overflow-x-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
              <RecommendationModeTabs mode={mode} onChange={setMode} />
            </div>
          </div>
      ...
      <div className="mx-auto max-w-7xl px-4 pb-20 pt-2 sm:px-6">
        <LocationContent menuItems={menuItems} searchQuery={debouncedQuery} mode={mode} />
      </div>
    </>
  );
}
