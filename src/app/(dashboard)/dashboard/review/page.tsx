...
// // Images served from /public/Image/... — swap these paths for whichever
// // files you actually want per dish.
...
//   const tabs: FilterTab[] = [
//     { id: "all", label: "ទាំងអស់", count: 10 },
//     { id: "meal", label: "ម្ហូបអាហារ", count: 2 },
//     { id: "drink", label: "ភេសជ្ជៈ", count: 2 },
//     { id: "shop", label: "ហាង", count: 1 },
//   ];
...
//   const filteredItems = useMemo(() => {
//     const items =
//       activeTab === "all" ? mockItems : mockItems.filter((item) => item.category === activeTab);

//     const sorted = [...items].sort((a, b) => a.sortDate.localeCompare(b.sortDate));
//     return sortOrder === "oldest" ? sorted : sorted.reverse();
//   }, [activeTab, sortOrder]);

//   const activeSortLabel = sortOptions.find((o) => o.id === sortOrder)?.label ?? "ចាស់បំផុត";
