  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* the card itself */}
        <div className="overflow-hidden rounded-[24px] bg-white pt-4 shadow-2xl ring-1 ring-black/5">
          <button
            type="button"
            onClick={onClose}
            aria-label="បិទ"
          ...
          <div className="relative mx-3 mt-2 aspect-[4/3] overflow-hidden rounded-[16px]">
            <img
              src={food.image}
              alt={food.name}
          ...
          <div className="mt-1 flex items-center gap-2 border-t border-gray-100 px-4 py-3">
...
function CollectionSheet({
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="relative flex max-h-[80vh] w-full max-w-md flex-col rounded-t-[28px] bg-white shadow-2xl sm:rounded-[28px]"
  ...
  return (
    <div className="flex flex-col items-center gap-6 py-10 px-4">
      ...
      <button
        ...
        className="relative flex items-center gap-2 rounded-full border border-gray-100 bg-white px-5 py-2.5 text-[14px] font-medium text-primary-900 shadow-md transition-transform active:scale-95"
      >
